...
export const propertiesSchema = new schema.Entity('properties');
export const propertiesArraySchema = [propertySchema];

export const propertySchema = new schema.Entity('property');
export const propertyArraySchema = [propertySchema];
